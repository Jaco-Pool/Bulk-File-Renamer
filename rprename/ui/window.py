...
class Ui_Window(object):
    def setupUi(self, Window):
        ...
        self.scrFileList = QtWidgets.QListWidget(self.widget)
        self.scrFileList.setObjectName("scrFileList")
        self.verticalLayout.addWidget(self.scrFileList)
    ...
    def retranslateUi(self, Window):
        ...
        self.label_4.setText(_translate("Window", "File name prefix:"))
